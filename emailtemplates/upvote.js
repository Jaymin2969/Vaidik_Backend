export default function upvoteTemplate(name, question, answer) {
    return `<!DOCTYPE HTML>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="https://vaidik-backend.onrender.com/api/v1/logo/favicon" />8
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 39.2px;"><span
                                                                                    ...
                                                                                    Congrats!! Student liked your answer</span>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style=" font-size: 15px; margin-top: 11px; ">
                                                                        Congratulations! One of your answers on DoubtQ
                                                                        has received an upvote from a student.
                                                                    </p>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="line-height: 160%;margin-top: 10px; font-size: 14px;"><span
