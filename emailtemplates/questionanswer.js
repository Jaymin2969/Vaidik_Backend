export default function questionanswerTemplate(name){
    return `<!DOCTYPE HTML>
                                        ...
                                        <div style="height: 100%;width: 100% !important;">
                                            <div
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style=" font-size: 15px; margin-top: 11px;padding: 0px 10px 0px 10px; ">
                                                                        I wanted to inform you that your question on
                                                                        DoubtQ has been answered
                                                                        by one of our expert tutors. To access the
                                                                        answer, simply click on the link below:
                                                                    </p>
                                                                </div>
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;font-family: Arial;padding: 0px 10px 15px;"
                                                                align="left">
    
                                                                <div
                                                                    style="color: #e5eaf5; line-height: 140%; text-align: center; word-break: break-word;">
                                                                    <p
                                                                        style="padding-top: 6px;font-size: 14px; line-height: 140%;">
                                                                        <span
                                                                            style="font-size: 24px; line-height: 39.2px;">
                                                                            <strong>
                                                                            <a href="https://vaidik-backend.onrender.com">
                                                                                <span
                                                                                    style="line-height: 39.2px;font-size: 18px;background-color: #ED2BFD;padding: 10px 35px 10px 35px;border-radius: 26px; box-shadow: 0px 6px 4px 0px #c3b5ac;">
                                                                                    View answer
                                                                                </span>
                                                                            </a> 
                                                                            </strong>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <p style="line-height: 160%; font-size: 14px;padding: 0px 10px 0px 10px;">
                                                                        <span
                                                                            style="font-size: 15px; line-height: 28.8px;">
                                                                            If you have any further questions or require
                                                                            additional assistance, please don't hesitate
                                                                            to contact us.
