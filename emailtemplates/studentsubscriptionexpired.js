export default function studentsubscriptionexpiredTemplate() {
    return `<!DOCTYPE HTML>
            ...
            <tbody>
                <tr style="vertical-align: top">
                    <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family: Arial;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <strong>
                                                                            T H A N K S&nbsp; &nbsp;F O R&nbsp; &nbsp;S U B S C R I B E !!</strong>
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 39.2px;"><span
                                                                                    ...
                                                                                    Your subscription has expired </span>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                            ...
                                            <div
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:20px 20px 0px 20px;font-family: Arial;">
    
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <!-- <p
                                                                        style="line-height: 160%;font-size: 14px;margin-top: 16px;">
                                                                        <span
                                                                            style="font-size: 15px; line-height: 28.8px;color: #1dc05c;">
                                                                            Your subscription has expired
                                                                        </span>
                                                                    </p> -->
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;">Dear [Student's name],</span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            We hope you enjoyed your time with our tutor website! We wanted to inform you that your subscription has expired.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; margin-top: 7px; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            If you found value in our tutoring service and would like to continue learning with our expert tutors, we invite you to renew your subscription. Extend your access to personalized support and academic guidance to excel in your studies.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; margin-top: 7px; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Visit our website today to renew your subscription and continue your journey towards academic success!
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                        ...
                        <div class="u-row-container" style="padding: 13px;background-color: transparent">
                            <div class="u-row"
