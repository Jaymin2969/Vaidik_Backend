export default function suspendtutorTemplate() {
    return `<!DOCTYPE HTML>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 24px; line-height: 39.2px;"><strong><span
                                                                                    style="line-height: 39.2px; font-size: 24px;">Your
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <p style="margin-top: 15px;">
                                                                        SORRY!! Your DoubtQ account has been terminated
                                                                        due to multiple violations of the DoubtQ
                                                                        Policies by an associated DoubtQ account.
                                                                    </p>
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span
                                                                            ...
                                                                            We’ve reviewed and confirmed this
                                                                            association.
                                                                        </span>
                                                                    </p>
    
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;">Thanks!</span>
                                                                    </p>
