export default function tutorregisterVerifyTemplate(id,token) {
    return `<!DOCTYPE HTML>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family: Arial;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <strong>
                                                                            T H A N K S&nbsp; &nbsp;F O R&nbsp; &nbsp;S I G N I N G&nbsp; &nbsp;U P !</strong>
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 39.2px;"><span
                                                                                    style="line-height: 39.2px; font-size: 18px;">Verification Email </span>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                        ...
                                        <div style="height: 100%;width: 100% !important;">
                                            <div
                                                ...
                                                <table style="font-family: Arial;" role="presentation"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:20px;font-family: Arial;text-align: center;"
                                                                >
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style=" font-size: 15px; margin-top: 11px; ">
                                                                        To complete your profile and start taking  your knowledge rides with DoubtQ , you'll need to verify your email address. 
                                                                    </p>
                                                                </div>
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;font-family: Arial;padding: 0px 10px 15px;" align="left">
    
                                                                <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-break: break-word;">
                                                                <p style="padding-top: 6px;font-size: 14px; line-height: 140%;">
                                                                    <span style="font-size: 24px; line-height: 39.2px;">
                                                                        <strong>
                                                                        <a href="https://vaidik-backend.onrender.com/api/v1/tutor/${id}/${token}">
                                                                            <span style="line-height: 39.2px;font-size: 18px;background-color: #ED2BFD;padding: 10px 35px 10px 35px;border-radius: 26px; box-shadow: 0px 6px 4px 0px #c3b5ac;">
                                                                                VERIFY
                                                                            </span>
                                                                        </a> 
                                                                        </strong>
    ...
    <table style="font-family: Arial;" role="presentation" cellpadding="0" cellspacing="0" width="100%"
        ...
        <tbody>
            <tr>
                <td style="overflow-wrap:break-word;word-break:break-word;padding-left:20px;font-family: Arial;text-align: center;"
                    >
    
                    <div style="line-height: 160%; word-wrap: break-word;">
                        <p style="line-height: 160%; font-size: 14px;padding: 0px 18px 0px 0px;">
