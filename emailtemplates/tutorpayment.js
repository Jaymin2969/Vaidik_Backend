export default function tutorpaymentTemplate() {
    return `<!DOCTYPE HTML>
                                            ...
                                            <div
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p
                                                                        style="line-height: 160%;margin-top: 15px; font-size: 14px;padding: 0px 13px 0px 0px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            We are pleased to inform you that your payment
                                                                            withdrawal has
                                                                            been successfully processed. The funds have been
                                                                            transferred to
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:0px 20px 0px 20px;font-family: Arial;">
    
                                                                <div
                                                                    style="line-height: 160%;margin-top: 10px; word-wrap: break-word;">
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Withdrawal Amount: [Insert Withdrawal Amount]
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Withdrawal Date: [Insert Withdrawal Date]
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Your payout covers the period from [Start Date]
                                                                            to [End Date].
                                                                            We appreciate your valuable contributions during
                                                                            this period.
                                                                        </span>
                                                                    </p>
                                                                    <p
                                                                        style="line-height: 160%;margin-top: 10px; font-size: 14px;padding: 0px 20px 0px 0px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            If you have any questions or need further
                                                                            assistance regarding your
                                                                            payment or any other matter, please feel free to
                                                                            contact our support
                                                                            team. We are here to support you and ensure a
                                                                    ...
                                                                    <p
                                                                        style="line-height: 160%;margin-top: 10px; font-size: 14px;padding: 0px 20px 0px 0px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Thank you for being a valued tutor on DoubtQ. We
                                                                            appreciate your
                                                                            dedication and look forward to your continued
                                                                            success.
                                                                        </span>
                                                                    </p>
                                                                    ...
                                                                    <p
                                                                        style="line-height: 160%; font-size: 14px;padding-bottom: 20px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            DoubtQ team
                                                                        </span>
                                                                    </p>
