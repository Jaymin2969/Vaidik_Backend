export default function tutorregistrationTemplate() {
    return `<!DOCTYPE HTML>
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;">Dear Tutor,</span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            We are pleased to inform you that your
                                                                            registration with DoubtQ has been
                                                                            completed successfully! <br> If you have any
                                                                            questions or need help getting
                                                                            started, our support team is here to assist
                                                                            you. You can reach us at
                                                                            <a>support@gmail.com</a> Welcome aboard,
                                                                            DoubtQ Team
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
