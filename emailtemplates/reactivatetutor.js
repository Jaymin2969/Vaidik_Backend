export default function reactivatetutorTemplate(name) {
    return `<!DOCTYPE HTML>
                                        ...
                                        <div style="height: 100%;width: 100% !important;">
                                            <div
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:20px;font-family: Arial;"
                                                                align="center">
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                                            ...
                                                                            <img border="0"
                                                                                src="https://vaidik-backend.onrender.com/api/v1/logo/doubtq"
                                        ...
                                        <div style="height: 100%;width: 100% !important;">
                                            <div
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 10px;font-family: Arial;"
                                                                align="left">
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family: Arial;"
                                                                align="left">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 24px; line-height: 39.2px;"><strong><span
                                                                                    style="line-height: 39.2px; font-size: 24px;">Account
                                            ...
                                            <div
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:0px 20px;font-family: Arial;">
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p
                                                                        style="line-height: 160%;margin-top: 15px; font-size: 14px;">
                                                                        <span
                                                                            style="font-size: 15px; line-height: 28.8px;">
                                                                            We are delighted to inform you that your tutor account on DoubtQ has been successfully reactivated. Welcome back!
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding-left:20px;font-family: Arial;">
                                                                ...
                                                                <div style="line-height: 160%;margin-top: 10px; word-wrap: break-word;">
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span
                                                                            ...
                                                                            We apologize for any inconvenience caused during the suspension period,
                                                                                and we appreciate your patience. Your account is now active, allowing 
                                                                                you to resume tutoring students and contributing your expertise on DoubtQ.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%;margin-top: 10px; font-size: 14px;">
                                                                        <span
                                                                            style="font-size: 15px; line-height: 28.8px;">
                                                                            If you have any questions or need assistance with anything, please do not hesitate 
                                                                            to reach out to our support team. We are here to support you in delivering exceptional
                                                                    ...
                                                                    <p style="line-height: 160%;margin-top: 10px; font-size: 14px;">
                                                                        <span
                                                                            style="font-size: 15px; line-height: 28.8px;">
                                                                            Thank you for being a valued member of DoubtQ. We look forward to assisting you in your academic journey.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span
