export default function studentsubscriptionTemplate(name) {
    return `<!DOCTYPE HTML>
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <p
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            Welcome to our student subscription!
                                                                        </span>
                                                                    </p>
                                                                    ...
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Thank you for subscribing to our student service. Get ready to supercharge your learning journey!
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Unlock your academic potential and make the most of your student experience. Start exploring the vast world of knowledge today!
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
