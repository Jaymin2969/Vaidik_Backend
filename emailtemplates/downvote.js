export default function downvoteTemplate(name,question,answer){
    return `<!DOCTYPE HTML>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 39.2px;"><span
                                                                                    style="line-height: 39.2px; font-size: 18px;">
                                                                                    Sorry!! Student not liked Your Answer    
                                                                                </span>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                            ...
                                            <div
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:20px;font-family: Arial;text-align: left;">
    
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <p>
                                                                        Dear ${name},
                                                                    </p>
                                                                    <p style=" font-size: 15px; margin-top: 11px; ">
                                                                        We wanted to inform you that one of your answers on DoubtQ has received a 
                                                                        downvote from a student. This feedback serves as an opportunity for improvement and growth.
                                                                    </p>
                                                                </div>
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding-left:20px;font-family: Arial;text-align: left;">
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;">Answer:
                                                                            ${answer}</span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;padding: 0px 20px 0px 0px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;"><br>
                                                                            We encourage you to reflect on the downvote and consider ways to enhance
                                                                                the clarity and effectiveness of your response. Your dedication to improving 
                                                                                your tutoring skills is crucial in providing exceptional support to our students.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%;margin-top: 10px; font-size: 14px;padding: 0px 30px 0px 0px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;">
                                                                            Thank you for your continued contributions to DoubtQ. We believe in your 
                                                                            ability to learn from this feedback and strive for excellence.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
