export default function tutorwarningquestionTemplate(name,quesion) {
    return `<!DOCTYPE HTML>
                                            ...
                                            <div
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style=" font-size: 15px; margin-top: 11px; ">
                                                                        We understand that tutoring can be a challenging
                                                                        job,
                                                                        but we expect our tutors to provide the highest
                                                                        level
                                                                        of service to our students. We urge you to take
                                                                        immediate
                                                                        action to improve the quality of your services and
                                                                        ensure
                                                ...
                                                <table style="font-family: Arial;" role="presentation" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td
                                                                style="overflow-wrap:break-word;word-break:break-word;padding:0px 20px 0px 20px;font-family: Arial;text-align: left;">
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            ...
                                                                            Thank you for your valuable contribution and
                                                                            dedication to DoubtQ.
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <span
                                                                            style="font-size: 15px; line-height: 28.8px;">Keep
