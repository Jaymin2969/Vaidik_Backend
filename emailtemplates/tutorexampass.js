export default function tutorexampassTemplate() {
    return `<!DOCTYPE HTML>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family: Arial;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <strong>
                                                                            C O N G R A T U L A T I O N !&nbsp; &nbsp; Y O U
                                                                            &nbsp; &nbsp;
                                                                            P A S S E D &nbsp; &nbsp; T
                                                                            H E &nbsp; &nbsp;
                                                                            E X A M</strong>
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    <!-- <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;">Dear
                                                                            [Student's name],</span>
                                                                    </p> -->
                                                                    <p
                                                                        style="line-height: 160%; font-size: 14px; margin-top: 20px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            We are delighted to inform you that you have
                                                                            successfully passed the exam on our Doubtq
                                                                            website. This is a significant
                                                                            accomplishment and a testament to your
                                                                            dedication, knowledge, and hard work.
                                                                        </span>
                                                                    </p>
                                                                    <p
                                                                        style="line-height: 160%; font-size: 14px; margin-top: 20px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            We extend our warmest congratulations to you for
                                                                            your outstanding performance. Your exceptional
                                                                            understanding of the
                                                                            subject matter and your ability to apply your
                                                                            knowledge have been truly impressive.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;"><br>Once
                                                                            again, congratulations on this remarkable
                                                                            achievement! We look forward to seeing your
                                                                            continued success on our platform.
                                                                        </span>
                                                                    </p>
                                                                    <p
