export default function  tutorexamfailTemplate() {
    return `<!DOCTYPE HTML>
                                                                ...
                                                                <div style="line-height: 160%; word-wrap: break-word;">
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            ...
                                                                            the recent exam on our DoubtQ website. We
                                                                            understand that this may be
                                                                            disappointing, but we encourage you to view this
                                                                            setback as an opportunity for growth and
                                                                            improvement.
                                                                        </span>
                                                                    </p>
                                                                    <p
                                                                        style="line-height: 160%; font-size: 14px; margin-top: 20px;">
                                                                        <span style="font-size: 15px; line-height: 28.8px;">
                                                                            Our platform is committed to supporting you in
                                                                            your professional growth. If you would like
                                                                            assistance in identifying
                                                                            areas for improvement or if you need any
                                                                            guidance We
                                                                            are here to help you succeed.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                                            style="font-size: 15px; line-height: 28.8px;"><br>If
                                                                            you have any questions or need further
                                                                            assistance, please don't hesitate to reach out
                                                                            to us. We are here to support
                                                                            you we can.</span>
                                                                    </p>
                                                                    <p
